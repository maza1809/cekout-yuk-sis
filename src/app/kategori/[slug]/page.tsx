...
const categories = [
  { slug: "skincare", name: "Skincare", icon: "Sparkles", description: "Rawat kulit wajahmu dengan produk skincare terbaik dari berbagai brand ternama. Temukan moisturizer, serum, sunscreen, dan lainnya untuk kulit sehat bercahaya." },
  { slug: "fragrance", name: "Fragrance", icon: "Flower2", description: "Temukan wewangian favoritmu, dari parfum lokal hingga import. Aroma tahan lama yang bikin kamu percaya diri sepanjang hari." },
  { slug: "makeup", name: "Makeup", icon: "Paintbrush", description: "Lengkapi makeup look-mu dengan koleksi kosmetik terbaru dan viral. Dari lip cream hingga foundation, semua ada di sini." },
  { slug: "bodycare", name: "Body Care", icon: "Heart", description: "Rawat tubuhmu dari ujung rambut sampai ujung kaki dengan produk body care terbaik. Body lotion, scrub, sabun, dan lainnya." },
  { slug: "haircare", name: "Hair Care", icon: "Scissors", description: "Dapatkan rambut indah dan sehat dengan produk haircare pilihan. Hair vitamin, shampoo, conditioner, dan treatment." },
  { slug: "fashion", name: "Fashion", icon: "Shirt", description: "Tampil stylish setiap hari dengan koleksi fashion terkini. Pakaian, aksesoris, dan outfit kekinian untuk segala acara." },
  { slug: "bags", name: "Tas", icon: "ShoppingBag", description: "Koleksi tas untuk segala acara, dari casual hingga formal. Temukan tas impianmu dengan harga terbaik." },
  { slug: "shoes", name: "Sepatu", icon: "Footprints", description: "Langkah percaya diri dengan sepatu kekinian dan nyaman. Sneakers, heels, flats, dan sandal untuk setiap momen." },
  { slug: "beautytools", name: "Beauty Tools", icon: "Wand", description: "Tools dan aksesoris kecantikan untuk mendukung rutinitas skincare-mu. Setting spray, kuas, sponge, dan lainnya." },
]
...
export default function CategoryDetailPage() {
  ...
  const categoryProducts = useMemo(() => {
    return demoProducts.filter((p) => p.category_id === slug)
  }, [slug])
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result
  }, [categoryProducts, search, selectedBrands, priceMin, priceMax, selectedRating, sort])
  ...
  const catBrandList = [...new Set(categoryProducts.map((p) => p.brand_id))]
  ...
  const hasActiveFilters =
    search || selectedBrands.length > 0 || priceMin || priceMax || selectedRating > 0
  ...
  if (!category) {
    return (
      <div className="container mx-auto flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 text-muted-foreground">Kategori yang kamu cari tidak tersedia.</p>
  ...
  return (
    ...
    >
      <div className="border-b bg-gradient-to-r from-primary/5 via-primary/10 to-transparent">
          ...
          <div className="flex-1">
            <div className="mb-4 hidden items-center justify-between lg:flex">
              <p className="text-sm text-muted-foreground">
                Menampilkan{" "}
                <span className="font-medium text-foreground">{displayProducts.length}</span> dari{" "}
